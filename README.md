...
This repository contains various search engine plugins that I developed for qBittorrent, an amazing and open source
torrent client.
...
Due to qBittorrent behavior, to update unofficial plugins you must check this repository periodically or wait until a
plugin stops working for you.

_If you want improve such behavior, please help me reaching qBittorrent's developer by
upvoting: [Improve Plugin Manager behavior](https://github.com/qbittorrent/qBittorrent/issues/17445)_
...
- The other way is to save the file in a temporary location by going to the download link and saving the document as a \*
  \*python file\*\*, `.py`. Then you can install the plugin by selecting the file from your filesystem.

Some plugins may need additional settings to work properly, please read carefully the _Notes_ section.

For any doubts about the installation process, please refer to the official
wiki: [Install search plugins](https://github.com/qbittorrent/search-plugins/wiki/Install-search-plugins).
...
| ![BitSearch](./src/engines/bitsearch.png) BitSearch                      | Torrent Index | **1.0** - _(25/02/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/bitsearch.py)</div>                                                                                                                                                                       |
| ![BT4G](./src/engines/bt4g.png) BT4G                                     | Torrent Index | **1.0** - _(25/02/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/bt4g.py)</div>                                                                                                                                                                            |
...
| ![CloudTorrents](./src/engines/cloudtorrents.png) CloudTorrents          | Torrent Index | **1.0** - _(25/02/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/cloudtorrents.py)</div>                                                                                                                                                                   |
...
| ![FileMood](./src/engines/filemood.png) FileMood                         | Torrent Index | **1.0** - _(25/02/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/filemood.py)</div>                                                                                                                                                                        |
...
| ![IlCorsaroNero](./src/engines/ilcorsaronero.png) IlCorsaroNero          | Torrent Index | **1.8** - _(27/10/2024)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/ilcorsaronero.py)</div>                                                                                                                                                                   |
| ![Kickasstorrents](./src/engines/kickasstorrents.png) Kickasstorrents    | Torrent Index | **1.2** - _(22/02/2026)_ | :question:               | <span>KATCR is using cloudflare, the plugin will not when CF is active. So the plugin is unstable and will work only when CF is set to low threats.</span> <br/><div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/kickasstorrents.py)</div> |
| ![LimeTorrents](./src/engines/limetorrents.png) LimeTorrents             | Torrent Index | **1.1** - _(21/06/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/limetorrents.py)</div>                                                                                                                                                                    |
...
| ![TorrentDownload](./src/engines/torrentdownload.png) TorrentDownload    | Aggregator    | **1.1** - _(23/11/2023)_ | :heavy_check_mark:       | <div align=center> [<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/torrentdownload.py)</div>                                                                                                                                                                |
| ![TorrentQuest](./src/engines/torrentquest.png) TorrentQuest             | Torrent Index | **1.0** - _(25/02/2025)_ | :heavy_check_mark:       | <div align=center>[<img src="https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/.github/assets/images/dl_image.png" width=32>](https://raw.githubusercontent.com/LightDestory/qBittorrent-Search-Plugins/master/src/engines/torrentquest.py)</div>                                                                                                                                                                    |
...
If you want to create a new search engine, please refer to
